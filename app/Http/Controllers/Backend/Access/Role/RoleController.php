...
class RoleController extends Controller
{
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return redirect()->route('admin.access.role.index')->with('flash_success',trans('alerts.backend.roles.created'));
    }
    ...
    public function update(Role $role, UpdateRoleRequest $request)
    {
        ...
        return redirect()->route('admin.access.role.index')->with('flash_success',trans('alerts.backend.roles.updated'));
    }
    ...
    public function destroy(Role $role, ManageRoleRequest $request)
    {
        ...
        return redirect()->route('admin.access.role.index')->with('flash_success',trans('alerts.backend.roles.deleted'));
    }
}
